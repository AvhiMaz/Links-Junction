...
const Buttonsss = () => {
  return (
    <>
      <div className="pl-2 items-center justify-center w-full">
        <div
          style={{ width: "100%" }}
          className="flex items-center justify-center mt-3 w-full"
        >
          <a href="https://www.instagram.com/avhi.ai/">
            <button
              type="button"
            ...
            >
              <svg
                ...
                fill="currentColor"
                class="bi bi-instagram w-20 h-10 me-1"
                viewBox="6 0 16 16"
              >
        ...
        <div className="flex items-center justify-center mt-1 w-full">
          <a href="https://www.linkedin.com/in/avhi-maz/">
            <button
              type="button"
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                class="bi bi-linkedin w-20 h-10 me-1"
                viewBox="6 0 16 16"
              >
        ...
        <div className="flex items-center justify-center mt-1 w-full">
          <a href="https://twitter.com/Avhi_Maz">
            <button
              type="button"
        ...
        <div className="flex items-center justify-center mt-1 w-full">
          <a href="mailto:avhimazumder5@gmail.com">
            <button
              type="button"
              class="text-gray-900 bg-red-500 hover:bg-red-600 border border-red-600 focus:ring-4 focus:outline-none focus:ring-red-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-red-600 dark:bg-red-800 dark:border-red-700 dark:text-white dark:hover:bg-red-700 me-2 mb-2"              style={{ width: "320px" }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                class="bi bi-envelope-paper-fill w-20 h-10 me-1"
                viewBox="6 0 16 16"
              >
                <path
                  fill-rule="evenodd"
              ...
              <div className="flex items-center justify-center pl-12">Gmail</div>
            </button>
          </a>
        </div>
      </div>
